            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Stack(children: [Image.asset("assets/icons/avataricon.png",),
                    Positioned(
                        right: 1,
                        bottom: 1,
                  ...
                  Column(crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(
                          "Ceyhun GÜL", style: buildTextStyle(22, Colors.black)
                      ),
                      Text(
                          "Kitap okuma ünvanı", style: buildTextStyle(15, Colors.grey)),
                    ],
                  )
                ],
              ...
              Row(
                children: [
                  ...
                  Text("Bilgilerim", style: buildTextStyle(20, Colors.black),)
                ],
              ), //bilgilerim
              /*Row(
                children: [
             ...
             /* Row(
              ...
              Row(
                children: [
                  ...
                  Text("Beğendiklerim", style: buildTextStyle(20, Colors.black),)
                ],
              ), //kütüphanem
              SizedBox(
              ...
              Container(
               // width: context.dynamicWidth(0.3),
                ...
                child: Center(child: Text("Henüz bir kitap beğenilmedi",style: buildTextStyle(15, Colors.black),)),
              ),
              ...
              Row(
                children: [
                  ...
                  TextButton(
                    ...
                    onPressed: () {},
                    child: Text(
                      "Çıkış yap", style: buildTextStyle(20, Colors.red),),)
                ],
              ) //cikis yap
            ],
          ),
