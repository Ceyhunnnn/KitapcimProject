...
class LibraryView extends GetxController{
  List<CategoryPickerItem> booksCategoryList=[
    CategoryPickerItem(value: "Romantik",label: "Romantik",),
  ...
  final List<String> booksGridList=["assets/books/au.jpg","assets/books/tcr.png","assets/books/as.png","assets/books/au.jpg","assets/books/tcr.png","assets/books/au.jpg"];
}